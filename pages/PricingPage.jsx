                        ...
                        <div className="min-h-screen bg-white text-gray-900">
                          ...
                          <main className="max-w-6xl mx-auto px-6 py-16">
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-14 items-start">
                              {/* Left column — descriptive block (spans two columns on desktop) */}
                                  ...
                                  {pricingPackages.map((pkg) => (
                                    <article key={pkg.name} className={`group border-t border-gray-200 pt-8 pb-6 ${pkg.featured ? 'relative bg-white' : ''}`}>
                                      ...
                                      <div className="mt-6 flex items-center gap-4">
                                        <button className={`px-5 py-2 rounded-sm border text-sm font-medium transition-colors ${pkg.featured ? 'bg-black text-white border-black hover:bg-gray-900' : 'text-gray-900 border-gray-300 hover:bg-gray-50'}`}>
                                          Book now
                                        </button>
